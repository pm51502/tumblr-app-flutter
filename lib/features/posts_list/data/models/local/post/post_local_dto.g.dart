...
void _postLocalDTOSerialize(
  ...
  writer.writeString(offsets[5], object.postUrl);
}
...
PostLocalDTO _postLocalDTODeserialize(
  ...
  final object = PostLocalDTO(
    ...
    postUrl: reader.readString(offsets[5]),
  );
  return object;
}
...
extension PostLocalDTOQuerySortBy
  ...
  QueryBuilder<PostLocalDTO, PostLocalDTO, QAfterSortBy> sortByCaption() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'caption', Sort.asc);
    });
  }

  QueryBuilder<PostLocalDTO, PostLocalDTO, QAfterSortBy> sortByCaptionDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PostLocalDTOQuerySortThenBy
  ...
  QueryBuilder<PostLocalDTO, PostLocalDTO, QAfterSortBy> thenByCaption() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'caption', Sort.asc);
    });
  }

  QueryBuilder<PostLocalDTO, PostLocalDTO, QAfterSortBy> thenByCaptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'caption', Sort.desc);
    });
  }
...
extension PostLocalDTOQueryWhereDistinct
  ...
  QueryBuilder<PostLocalDTO, PostLocalDTO, QDistinct> distinctByCaption(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension PostLocalDTOQueryProperty
  ...
  QueryBuilder<PostLocalDTO, String, QQueryOperations> captionProperty() {
    return QueryBuilder.apply(this, (query) {
